    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <article class="post">
                            ...
                            <h5>
                                last date for SEE exam registration for odd sesmester is 20-dec-2020 &nbsp; </h4>
                                <p class="mb-0">
                                    <a href="" class="read-more font-weight-bold text-2" style="color:#660033;">read more <i class="fas fa-chevron-right text-1 ml-1"></i></a>
                                </p>
                        ...
                        <article class="post">
                            ...
                            <h5>
                                last date for Fast track exam registration is 20-dec-2020 &nbsp;</h4>
                                <p class="mb-0">
                                    <a href="#" class="read-more font-weight-bold text-2" style="color:#660033;">read more <i class="fas fa-chevron-right text-1 ml-1"></i></a>
                                </p>
            ...
            <div class="col " id="navbar">
                ...
                <ul class="nav   nav-tabs nav-justified" style="background-color:#ffd802;">
                    <li class="nav-item">
                ...
                <div class="tab-content ">
                    ...
                    <div class="tab-pane container  active" id="home">
                        ...
                        <div style="  top:50%;">
                            <button type="button" class="btn m-3 btn-block mx-auto d-block  sembtn " style="border-radius: 10px;" data-target="#semester">Semester exam</button>
                            <button type="button" class="btn m-3 btn-block mx-auto d-block  fastbtn " style="border-radius: 10px;" data-target="#fasttrack">Fast-Track Semester exam</button>
                        </div>
                    </div>
                            ...
                            <div class="card-body  ">
                                ...
                                <div class=" p-1 login">
                                    ...
                                    <a href="#" style=" text-decoration:none;">
                                        <button type="button" class="btn  btn-block mt-2" style="background-color: #0e918c;border-radius: 30px;color:white;">Log Out</button>
                                    </a>
                                </div>
